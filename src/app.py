...
resumeDataSet = pd.read_csv('C:\\Users\\sasik\\OneDrive\\Desktop\\pds_resume_pro\\data\\resume_dataset.csv', encoding='utf-8')
skills_set = load_skills_dataset('C:\\Users\\sasik\\OneDrive\\Desktop\\pds_resume_pro\\data\\skills_30k.csv')
...
def analyze():
    ...
    top_skills = get_top_skills(pipeline, predicted_category_id, 20, skills_set=skills_set)
...
def top_skills(category_id):
    top_skills_data = get_top_skills(pipeline, category_id, 20, skills_set=skills_set)
